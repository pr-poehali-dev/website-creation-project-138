...
const services = [
  {
    icon: "Truck",
    title: "Вывоз мусора",
    desc: "Вывозим строительный, бытовой мусор, ветки, старую мебель. Быстрый выезд, честная цена за объём.",
  ...
  },
  {
    ...
    desc: "Снос и демонтаж строений любой сложности: дачи, гаражи, склады, промышленные объекты. Вывоз мусора включён.",
    img: "https://cdn.poehali.dev/projects/6ead581f-3841-42c2-9488-2d97f20a81fd/files/a9c2eb51-c1ca-471c-a2bd-ec6b0377b030.jpg",
    price: "Цена договорная",
  },
  {
    icon: "Shovel",
    title: "Расчистка и облагораживание участков",
    desc: "Расчищаем заросшие и захламлённые участки, убираем кустарники, пни, мусор. Превратим пустырь в ухоженную территорию.",
    img: "https://cdn.poehali.dev/projects/6ead581f-3841-42c2-9488-2d97f20a81fd/files/3572c7db-0db1-4df9-9e36-01da96ece3cf.jpg",
    price: "Цена договорная",
  },
  {
    icon: "Forklift",
    title: "Услуги ломовоза",
    desc: "Вывоз металлолома, крупногабаритного мусора и тяжёлых грузов манипулятором-ломовозом. Быстро и без лишних хлопот.",
    img: "https://cdn.poehali.dev/projects/6ead581f-3841-42c2-9488-2d97f20a81fd/files/673f7cf6-d7af-498c-9046-582d6ddf4c84.jpg",
    price: "Цена договорная",
  },
  {
    icon: "Tractor",
    title: "Услуги трактора",
    desc: "Планировка и выравнивание участков, уборка снега, перемещение грунта. Трактор с опытным оператором.",
    img: "https://cdn.poehali.dev/projects/6ead581f-3841-42c2-9488-2d97f20a81fd/files/7ca182b1-afc7-4bc8-b8ab-9d1323222e80.jpg",
    price: "Цена договорная",
  },
  {
    icon: "Construction",
    title: "Услуги экскаватора-погрузчика",
    desc: "Земляные работы, рытьё котлованов, траншей, погрузка и перемещение грунта. Аренда с оператором.",
    img: "https://cdn.poehali.dev/projects/6ead581f-3841-42c2-9488-2d97f20a81fd/files/0421f4a6-8502-445d-8ac9-f8eae98b2231.jpg",
    price: "Цена договорная",
  },
  {
    icon: "Package",
    title: "Вывоз мусора контейнером",
    desc: "Привезём контейнер, вы загружаете в удобное время — мы забираем. Объёмы от 8 до 27 кубометров.",
    img: "https://cdn.poehali.dev/projects/6ead581f-3841-42c2-9488-2d97f20a81fd/files/5105dfe0-d1f0-4c46-a9d2-1744c8d3b14a.jpg",
    price: "Цена договорная",
  },
  {
    icon: "Archive",
    title: "Аренда контейнера и бункера (пухто)",
    desc: "Аренда бункера-накопителя для стройплощадок, предприятий и частных лиц. Доставка, установка и вывоз включены.",
    img: "https://cdn.poehali.dev/projects/6ead581f-3841-42c2-9488-2d97f20a81fd/files/1f9ef376-1e0d-4068-9eaa-061f9e4c5a53.jpg",
    price: "Цена договорная",
  },
  {
    icon: "Leaf",
    title: "Покос участка",
    desc: "Скашиваем газоны, поля, заросшие участки любой площади. Профессиональная техника — быстро и чисто.",
    img: LAWN_IMG,
    price: "Цена договорная",
  },
  {
    ...
    desc: "Профессиональная обрезка, формировка кроны, удаление аварийных деревьев любой сложности и высоты.",
    img: TREE_IMG,
    price: "Цена договорная",
  },
];
