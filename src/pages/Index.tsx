...
const services = [
  ...
  {
    icon: "Hand",
    title: "Ручной подбор мусора",
    desc: "Аккуратная ручная уборка территории: сбор мелкого мусора, листьев, веток там, где техника не пройдёт.",
    img: "https://cdn.poehali.dev/files/cfdcaa05-99e9-47e1-8524-99c86d81916e.png",
    price: "Цена договорная",
  },
];
